CLASS zcl_excepciones_rpc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*Ejemplo 5: Almacenar una excepción en una variable
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    TRY.
        DATA(lv_result) = 10 / 0.
      CATCH cx_sy_zerodivide INTO DATA(lx_error).
       " WRITE: 'Error detectado:', lx_error->get_text( ).
        out->write( |Impresión de lx_error: { lx_error->get_text( ) }| ).
    ENDTRY.
