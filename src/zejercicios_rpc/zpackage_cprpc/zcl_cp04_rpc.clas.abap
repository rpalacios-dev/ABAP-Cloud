...
CLASS zcl_cp04_rpc IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    "CASO PRÁCTICO 4
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    "TAREA 1: Análisis del modelo actual
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

    "Volviendo a este ejercicio, todos los campos usan tipos genéricos
    "y todos ellos podrían beneficiarse de las ventajas de utilizar
    "un diccionario de datos.


    "TAREA 5: Refactorización
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
*    TYPES: BEGIN OF zst_booking_rpc,
*             id_reserva TYPE i,
...
*           END OF zst_booking_rpc.

    DATA lt_reservas TYPE  ztt_bookings_rpc.
    DATA ls_reserva TYPE zst_booking_rpc.

    "TAREA 6: Reflexión
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
*    1. Ventajas de usar diccionarios frente a tipos locales.
*    Permiten la reutilización global y son sencillos de mantener.
*
*    2. ¿Cuándo usuaría TYPES locales?
*    Para estructuras que norepetiré o para una sección privada de código
*
*    3. Elementos de datos - ABAP Clásico VS ABAP Cloud.
*    El dominio defines las propiedades y el elemento de datos aporta el texto.
*    Esta distinción existe en ABAP Cloud, aunque es más común usar CDS.
